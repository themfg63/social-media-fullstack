...
public class UserService implements UserDetailsService {
    ...
    public User registerUser(RegistrationObject object){
        ...
        user.setDateOfBirth(object.getDt());
    ...
    public String verifyUsername(FindUsernameDTO dto){
        User user = userRepository.findByEmailOrPhoneOrUsername(dto.getEmail(), dto.getPhone(), dto.getUsername())
                .orElseThrow(UserDoesNotExistException::new);
        return user.getUsername();
    }

    public User getUsersEmailAndPhone(FindUsernameDTO dto){
        return userRepository.findByEmailOrPhoneOrUsername(dto.getEmail(),dto.getPhone(),dto.getUsername())
                .orElseThrow(UserDoesNotExistException::new);
    }
}
